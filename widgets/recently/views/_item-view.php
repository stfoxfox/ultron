        ...
        <div class="element-visible-block">
            <div class="img-wrapper relative">
                ...
                <?php if ($model->displayCssLabel): ?>
                    <div class="sticker <?= $model->displayCssLabel ?>"><i
        ...
        <div class="element-hidden-block hidden-xs hidden-sm">
            ...
            <div class="row min">
                <?php if ($model->demo_url): ?>
                    <div class="col-xs-5">
                        <a href="<?= $model->demo_url ?>" target="_blank" class="btn btn-navy block first">Демо <i
                                    class="material-icons">remove_red_eye</i></a>
                    </div>
                <?php endif; ?>
                <div class="<?= $model->demo_url ? 'col-xs-7' : '' ?>">
                    <a href="<?= Url::to(['template/view', 'id' => $model->id]) ?>" class="btn block last">Подробнее <i
